...
public class SettingWindow extends JFrame {
    private static final int WINDOW_X = Lesson8.GameWindow.WINDOW_X + 50;
    private static final int WINDOW_Y = Lesson8.GameWindow.WINDOW_Y + 50;
    private static final int WINDOW_WIDTH = Lesson8.GameWindow.WINDOW_WIDTH - 100;
    private static final int WINDOW_HEIGHT = 400;

    private final int MIN_FIELD_SIZE = 3;
    private final int MAX_FIELD_SIZE = 10;

    private Lesson8.GameWindow gameWindow;
    ...
    public SettingWindow(Lesson8.GameWindow gameWindow) {
